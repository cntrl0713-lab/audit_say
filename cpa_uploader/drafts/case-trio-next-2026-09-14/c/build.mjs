...
const answers=[
 ...
 ['장기계약 영역에서는 소액 경비 영역보다 내부감사기능이 수행한 업무의 활용을 줄이도록 계획한다.','장기계약 영역에서는 외부감사인이 직접 수행할 업무를 늘리도록 계획한다.','장기계약은 소액 경비와 달리 유의적 위험으로 식별되어 더 설득력 있는 감사증거가 필요하므로, 같은 내부감사부가 수행했다는 이유로 낮은 위험의 정형적 경비업무와 같은 범위로 정할 수 없다.'],
...
const claims=[
 ...
 ['장기계약 영역에서 낮은 위험의 소액 경비 영역에 비하여 내부감사업무의 활용 범위를 줄이도록 계획한다고 제시한다.','장기계약 영역에서 낮은 위험의 소액 경비 영역에 비하여 외부감사인의 직접 수행업무를 늘리도록 계획한다고 제시한다.','장기계약의 유의적 위험 때문에 낮은 위험의 소액 경비보다 더 설득력 있는 증거가 필요하여 같은 업무 활용계획을 적용할 수 없다고 설명한다. 위험 수준 차이를 두 영역의 활용 범위 차이에 연결하면 충분하며, 많은 판단이라는 별도 근거를 숨은 요건으로 요구하지 않는다.'],
...
const wrong=['갑의 제안은 적절하다. 전문성이 높으면 영업이사가 자신의 지적사항을 삭제하는 보고체계도 보완되므로 해당 업무를 활용할 수 있다.','장기계약 영역에서는 내부감사업무 활용을 더 늘리고 외부감사인의 직접 수행업무를 줄인다. 두 영역의 위험 수준은 동일하다.','이 지원은 내부감사부가 이미 수행한 업무의 활용에 해당하며 직접적 보조는 아니다. 자격을 확인하고 동의서를 받으면 국내 감사에서도 허용된다.'];
...
const reasons=[
 ...
 '활용 축소1점·직접 수행 확대1점·두 업무의 위험 수준 차이를 적용한 근거1점이다. pilot-13-010/sub1의 일반 방향 명제와 같은 정수 원칙을 쓰며, 판단 부담에 따른 별도 조정·유의적 판단의 수행주체·유의적 위험에서 활용할 절차의 한계를 묻지 않아 요구를 과도하게 묶지 않는다.',
