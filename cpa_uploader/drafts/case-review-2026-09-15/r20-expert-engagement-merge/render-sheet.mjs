...
//   node cpa_uploader/drafts/case-review-2026-09-15/r20-expert-engagement-merge/render-sheet.mjs
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ②를 옳지 않다고 고르고 ③·⑤는 번호만, 물음 2는 ⑫의 이유·절차만, 물음 3은 함정 ⑰을 옳지 않다고 고르고 ⑭는 번호만)',
