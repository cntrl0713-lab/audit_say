...
//   node cpa_uploader/drafts/case-review-2026-09-15/r27-service-org-internal-audit-merge/render-sheet.mjs
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ④를 옳지 않다고 고름, 물음 2는 ⑧의 이유를 빠뜨림, 물음 3은 ⑫를 빠뜨림)',
