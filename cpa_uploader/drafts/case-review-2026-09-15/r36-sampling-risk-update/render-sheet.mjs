...
//   node cpa_uploader/drafts/case-review-2026-09-15/r36-sampling-risk-update/render-sheet.mjs
import fs from 'node:fs';

const D = 'cpa_uploader/drafts/case-review-2026-09-15/r36-sampling-risk-update';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r36';
...
const out = [
    `# ${set.title}`,
    '',
    `갱신 초안 \`${set.id}\` · 사례형 ${set.subquestions.length}물음 · ${total}점. 상태는 \`${set.status}\`이며 정본·운영 DB에는 아직 반영하지 않았다. 원 세트 \`pilot-10-006\`(2물음 6점)을 대체한다.`,
    '',
];
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 ③의 이유 누락, 물음 2는 함정 ⑤ 오선택과 ⑨ 누락, 물음 3은 ⑪의 이유 누락)',
