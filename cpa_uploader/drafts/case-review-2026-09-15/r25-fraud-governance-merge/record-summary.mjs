// r25 실행 요약 기록기. 대표 실측과 보조 실측을 마친 뒤 한 번만 실행한다.
//
//   node cpa_uploader/drafts/case-review-2026-09-15/r25-fraud-governance-merge/record-summary.mjs
//
// 출력: cpa_uploader/analysis/reviews/case-review-2026-09-15/r25/summary-v1.json
import fs from 'node:fs';
import { createHash } from 'node:crypto';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r25';
const D = 'cpa_uploader/drafts/case-review-2026-09-15/r25-fraud-governance-merge';
const SET = 'case-05-fraud-governance-20260921';
...
const summary = {
    version: 1, round: 'r25', draft_version: 'v1', set_id: SET, created_at: new Date().toISOString(),
    merged_from: ['case-05-management-override-20260913', 'case-05-governance-dialogue-20260914'],
    ...
    transferred_to_other_round: {
        target: 'r21 (회계추정 묶음, 17·54번)',
        requirement: 'case-05-management-override-20260913 sub3의 회계추정치 편의 검토(KGA 240 문단 33(b), 3점)',
        note: '설계서 지시에 따라 이 세트에 승계하지 않았다. 원 세트를 퇴역하기 전에 r21 초안에서 그 요구가 실제로 다루어졌는지 대조해야 한다.',
    },
    not_done: [
        '정본·공개본·암호화본 반영',
        '운영 DB 등록',
        '원 두 세트(case-05-management-override-20260913, case-05-governance-dialogue-20260914)의 활성 릴리스 제외(퇴역)',
        '승급 receipt 봉인(authorization.production_publication 미승인)',
        'coverage links 갱신',
        '수정 요청서·검토 장부·drafts README 갱신(메인 세션 담당)',
        'r21 초안과의 회계추정 편의 요구 중복 대조',
    ],
};
