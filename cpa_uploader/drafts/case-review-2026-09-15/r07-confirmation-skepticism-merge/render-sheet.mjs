...
//   node cpa_uploader/drafts/case-review-2026-09-15/r07-confirmation-skepticism-merge/render-sheet.mjs
...
const labels = { model: '저장 모범답안', partial: '대표 부분정답(물음 1은 함정 ③ 선택과 ② 이유 누락, 물음 2는 ⑥ 누락과 함정 ⑧ 선택)', wrong: '대표 오답(함정만 고르고 옳지 않은 항목을 옳다고 명시)' };
...
out.push('', '대표 답안 원문과 기대 판정은 [qa.json](qa.json), 원응답·사용량은 [검증 장부](../../../analysis/reviews/case-review-2026-09-15/README.md#r07-입력과-실행)에 있다.', '');
