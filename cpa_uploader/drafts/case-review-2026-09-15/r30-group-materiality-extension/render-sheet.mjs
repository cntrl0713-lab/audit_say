...
//   node cpa_uploader/drafts/case-review-2026-09-15/r30-group-materiality-extension/render-sheet.mjs
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ③을 옳지 않다고 고르고 ⑤를 빠뜨림, 물음 2는 ⑨의 이유를 빠뜨림, 물음 3은 ⑬을 빠뜨림)',
