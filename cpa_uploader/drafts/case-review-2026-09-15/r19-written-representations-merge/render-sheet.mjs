...
//   node cpa_uploader/drafts/case-review-2026-09-15/r19-written-representations-merge/render-sheet.mjs
import fs from 'node:fs';

const D = 'cpa_uploader/drafts/case-review-2026-09-15/r19-written-representations-merge';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r19';
const ACTUAL = 'actual-a2';
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ③을 골라 ②를 빠뜨리고, 물음 2는 ⑧을, 물음 3은 ⑬의 이유를 빠뜨림)',
    wrong: '대표 오답(옳은 항목만 고르고 그 근거도 기준서에 어긋남)',
};
