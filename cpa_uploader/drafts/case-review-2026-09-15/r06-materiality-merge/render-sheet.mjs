...
//   node cpa_uploader/drafts/case-review-2026-09-15/r06-materiality-merge/render-sheet.mjs
...
const labels = { model: '저장 모범답안', partial: '대표 부분정답(물음 1은 함정 ① 선택, 물음 2는 ⑥ 누락과 함정 ⑧ 선택)', wrong: '대표 오답(함정만 고르고 옳지 않은 항목을 옳다고 명시)' };
