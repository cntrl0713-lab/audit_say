...
//   node cpa_uploader/drafts/case-review-2026-09-15/r05-audit-documentation/render-sheet.mjs
...
const labels = { model: '저장 모범답안', partial: '대표 부분정답(물음 1은 ⑤를 적절로 판단하고 함정 ⑥ 선택, 물음 2는 함정 ⑧ 선택)', wrong: '대표 오답(함정만 적절하지 않다고 하고 적절하지 않은 항목을 적절하다고 명시)' };
