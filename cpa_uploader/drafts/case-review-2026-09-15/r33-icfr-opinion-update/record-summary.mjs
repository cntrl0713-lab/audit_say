// r33 실행 요약 기록기. 실제 채점이 끝난 뒤 한 번만 실행한다.
//   node cpa_uploader/drafts/case-review-2026-09-15/r33-icfr-opinion-update/record-summary.mjs
import fs from 'node:fs';
import { createHash } from 'node:crypto';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r33';
const D = 'cpa_uploader/drafts/case-review-2026-09-15/r33-icfr-opinion-update';
const SET = 'case-17-icfr-opinion-20260921';
...
const summary = {
    version: 1, round: 'r33', draft_version: 'v1', set_id: SET, created_at: new Date().toISOString(),
    route: 'case_single_update',
    updated_set: 'pilot-17-005',
    edit_note_number: 22,
    ...
    supplementary: {
        run: false,
        reason: '대표 9답안의 점수가 모두 기대와 정확히 일치했고(delta 0) 허용 범위 밖 결과가 없어 보조 요청을 추가하지 않았다. 허용한 ±1점 편차를 없애기 위한 반복 호출도 하지 않았다. qa.json의 supplementary_cases 세 건은 run=false로 남겨 두었다.',
    },
    ...
    not_done: [
        '정본·공개본·암호화본 반영',
        '운영 DB 등록',
        '원 세트 pilot-17-005의 활성 릴리스 제외(퇴역)',
