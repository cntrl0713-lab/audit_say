...
//   node cpa_uploader/drafts/case-review-2026-09-15/r28-confirmation-extension/render-sheet.mjs
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ⑤를 옳지 않다고 고르고 ④를 빠뜨림, 물음 2는 ⑨의 이유만, 물음 3은 ⑭를 번호만)',
