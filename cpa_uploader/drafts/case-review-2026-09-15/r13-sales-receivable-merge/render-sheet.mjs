...
//   node cpa_uploader/drafts/case-review-2026-09-15/r13-sales-receivable-merge/render-sheet.mjs
import fs from 'node:fs';

const D = 'cpa_uploader/drafts/case-review-2026-09-15/r13-sales-receivable-merge';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r13';
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음마다 함정을 옳지 않다고 고르고, 물음 2는 ⑥을, 물음 3은 ⑪·⑭를 빠뜨림)',
