...
//   node cpa_uploader/drafts/case-review-2026-09-15/r12-analytical-procedures-merge/render-sheet.mjs
import fs from 'node:fs';

const D = 'cpa_uploader/drafts/case-review-2026-09-15/r12-analytical-procedures-merge';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r12';
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ⑤ 선택과 ④ 누락, 물음 2는 함정 ⑨ 선택과 ⑦ 누락)',
