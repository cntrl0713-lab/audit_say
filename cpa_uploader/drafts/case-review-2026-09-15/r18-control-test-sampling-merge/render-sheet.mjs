...
//   node cpa_uploader/drafts/case-review-2026-09-15/r18-control-test-sampling-merge/render-sheet.mjs
import fs from 'node:fs';

const D = 'cpa_uploader/drafts/case-review-2026-09-15/r18-control-test-sampling-merge';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r18';
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ④를 고르고 ③의 서술이 부족, 물음 2는 ⑥·⑧의 서술이 부족, 물음 3은 함정 ⑫를 고르고 ⑬을 옳다고 씀)',
