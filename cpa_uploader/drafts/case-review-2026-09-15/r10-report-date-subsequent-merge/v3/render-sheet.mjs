...
//   node cpa_uploader/drafts/case-review-2026-09-15/r10-report-date-subsequent-merge/v3/render-sheet.mjs
import fs from 'node:fs';
const D = 'cpa_uploader/drafts/case-review-2026-09-15/r10-report-date-subsequent-merge/v3';
...
const out = [`# ${set.title}`, '', `병합 초안 v3 \`${set.id}\` · 사례형 ${set.subquestions.length}물음 · ${set.subquestions.reduce((n, q) => n + points(q), 0)}점. 상태는 \`${set.status}\`이며 정본·운영 DB에는 아직 반영하지 않았다.`, ''];
