...
//   node cpa_uploader/drafts/case-review-2026-09-15/r08-kam-emphasis/render-sheet.mjs
import fs from 'node:fs';
const D = 'cpa_uploader/drafts/case-review-2026-09-15/r08-kam-emphasis';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r08';
...
const out = [`# ${set.title}`, '', `대체 초안 \`${set.id}\` · 사례형 ${set.subquestions.length}물음 · ${set.subquestions.reduce((n, q) => n + points(q), 0)}점. 상태는 \`${set.status}\`이며 정본·운영 DB에는 아직 반영하지 않았다.`, ''];
...
const labels = { model: '저장 모범답안', partial: '대표 부분정답(물음 1은 함정 ① 선택과 ④ 누락, 물음 2는 함정 ⑨ 선택과 ⑧ 누락, 물음 3은 함정 ⑭ 선택과 ⑬ 누락)', wrong: '대표 오답(함정만 고르고 옳지 않은 항목을 옳다고 명시)' };
...
out.push('', '대표 답안 원문과 기대 판정은 [qa.json](qa.json), 원응답·사용량은 [검증 장부](../../../analysis/reviews/case-review-2026-09-15/README.md#r08-입력과-실행)에 있다.', '');
