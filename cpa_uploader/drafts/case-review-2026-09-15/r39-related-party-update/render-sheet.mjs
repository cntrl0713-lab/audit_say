...
//   node cpa_uploader/drafts/case-review-2026-09-15/r39-related-party-update/render-sheet.mjs
...
const out = [
    `# ${set.title}`,
    '',
    `갱신 초안 \`${set.id}\` · 사례형 ${set.subquestions.length}물음 · ${total}점. 상태는 \`${set.status}\`이며 정본·운영 DB에는 아직 반영하지 않았다. 원 세트 \`case-11-undisclosed-related-party-20260913\`(3물음 8점)을 대체한다.`,
    '',
];
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 ⑥의 이유 누락, 물음 2는 함정 ⑩ 오선택, 물음 3은 ⑫의 이유 누락)',
