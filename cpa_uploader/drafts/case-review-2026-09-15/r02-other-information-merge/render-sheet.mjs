...
//   node cpa_uploader/drafts/case-review-2026-09-15/r02-other-information-merge/render-sheet.mjs
...
for (const kind of ['model', 'partial', 'wrong']) {
  ...
  out.push(`| ${{ model: '저장 모범답안', partial: '대표 부분정답(함정 ③·⑦ 선택, ⑤·⑧ 누락)', wrong: '대표 오답(함정만 선택)' }[kind]} | ${s('sub1').expected_points} / ${s('sub1').actual_points} | ${s('sub2').expected_points} / ${s('sub2').actual_points} |`);
}
