...
const SET = 'case-12-going-concern-20260920';
...
const summary = {
    version: 1, round: 'r16', draft_version: 'v1', set_id: SET, created_at: new Date().toISOString(),
    ...
    not_done: [
        '정본·공개본·암호화본 반영',
        '운영 DB 등록',
        '원 두 세트(pilot-12-001, case-12-going-concern-evidence-20260914)의 활성 릴리스 제외(퇴역)',
