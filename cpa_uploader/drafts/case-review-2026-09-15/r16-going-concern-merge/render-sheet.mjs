...
//   node cpa_uploader/drafts/case-review-2026-09-15/r16-going-concern-merge/render-sheet.mjs
import fs from 'node:fs';

const D = 'cpa_uploader/drafts/case-review-2026-09-15/r16-going-concern-merge';
const R = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/r16';
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ②를 옳지 않다고 고름, 물음 2는 ⑦의 이유만 씀, 물음 3은 ⑯을 빠뜨림)',
