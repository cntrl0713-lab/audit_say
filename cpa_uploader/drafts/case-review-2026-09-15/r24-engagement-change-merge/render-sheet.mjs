...
//   node cpa_uploader/drafts/case-review-2026-09-15/r24-engagement-change-merge/render-sheet.mjs
...
const labels = {
    model: '저장 모범답안',
    partial: '대표 부분정답(물음 1은 함정 ②를 옳지 않다고 고름, 물음 2는 ⑨의 이유만 씀, 물음 3은 번호만 씀)',
