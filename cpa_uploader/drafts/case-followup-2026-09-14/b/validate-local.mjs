...
const files=['sets.json','design.json','review.json','qa.json','coverage-proposals.json'];
...
const catalog=read('cpa_uploader/drafts/case-followup-2026-09-14/source-catalog-v3.json');
