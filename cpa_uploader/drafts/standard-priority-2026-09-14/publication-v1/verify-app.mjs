// 운영 DB 조회 경로와 운영 앱 /curriculum·/quiz 응답에서 신규 10개 독립 학습 단위를 확인한다. 쓰기 없음.
//   node --env-file=.env.local --import tsx cpa_uploader/drafts/standard-priority-2026-09-14/publication-v1/verify-app.mjs
...
const P='cpa_uploader/drafts/standard-priority-2026-09-14/publication-v1',D=P+'/db-publication-v1';
...
const selected=units.filter(u=>targetIds.includes(u.id));assert.equal(selected.length,10);
