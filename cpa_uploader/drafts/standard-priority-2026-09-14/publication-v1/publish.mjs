...
//   node --env-file=.env.local --import tsx cpa_uploader/drafts/standard-priority-2026-09-14/publication-v1/publish.mjs --stage|--install
...
const P='cpa_uploader/drafts/standard-priority-2026-09-14/publication-v1',stage=P+'/stage';
...
const NEW_SETS=5,NEW_QUESTIONS=10,NEW_POINTS=62,OLD_SETS=219,OLD_QUESTIONS=464;
