...
const preparationInputs=[prep.predecessor,prep.candidate,prep.original_qa,prep.regression_qa,...prep.plan_files,...prep.source_files];
...
if(lockHash!==prep.required_runtime_lock.sha256)throw Error('Followup requires the approved v4 lock');
...
if(!entry||entry.sha256!==prep.predecessor.sha256||entry.qa_sha256!==prep.original_qa.sha256)throw Error('Compared original inputs changed');
