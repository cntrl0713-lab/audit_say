...
const [planId,phase,label='run1',lockPath='cpa_uploader/analysis/reviews/delegated-authoring-2026-09-11/runtime-v3-stable/runtime-lock.json',priorSemantic,onlyCase]=process.argv.slice(2);
...
const folder=path.join(path.dirname(entry.file),'phase-two-v3',planId.toLowerCase(),label);
