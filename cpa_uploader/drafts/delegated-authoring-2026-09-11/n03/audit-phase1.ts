...
const result = { checked_at: new Date().toISOString(), phase: 'phase1_no_model_calls', catalog_fingerprint: catalog.fingerprint,
  comparison_file: initialFile, comparison_sha256: hash(fs.readFileSync(initialFile)), initial_sets: initial.length, n02_additional_sets: n02.length, comparison_sets_before_own_peers: comparison.length, comparison_is_final: false,
