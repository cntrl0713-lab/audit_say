...
const REGISTRY = 'cpa_uploader/analysis/reviews/point-review-and-publication-2026-09-11/source-parser-followup-v1/cpa_uploader__config__question-source-registry.json.before.txt';
...
function standardFromHeading(heading) {
  ...
  const match = heading.match(/^(?:KGA|감사기준서)\s*(\d{3,4})\b/u);
