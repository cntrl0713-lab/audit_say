...
const run = `${base}/execution-resumes/resume-2026-09-12-v3`;
const qa = 'cpa_uploader/drafts/delegated-authoring-2026-09-11/validation-resumes/resume-2026-09-12-v3';
...
console.log(JSON.stringify({ observed_at: new Date().toISOString(), version: 'question-verification-2026-09-12-resume-003',
