...
export const FROZEN_MANIFEST_SHA256 = 'a4045abe6110a9816f242ad92f6676c6e0eebf49e9dbb9a601b75431114b03e2';
...
export function prepare(options: Options) {
    ...
    assert.equal(manifest.version, 4); assert.equal(manifest.entries.length, 249); assert.equal(manifest.counts.source_sets, 119);
    freeze(SELF);
