...
import { parseArgs, partition, safeError, failureKind, rawSecurityFindings, fullCreditFindings, runSequential, verifyFrozenFile, GuardError, RecordingError } from './run-learning-unit-smoke-v5.ts';
...
const runner = path.join(owned, 'run-learning-unit-smoke-v5.ts');
const manifest = path.join(owned, 'learning-unit-smoke-v5/manifest.json');
