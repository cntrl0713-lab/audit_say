...
export const F='cpa_uploader/analysis/reviews/standard-new-verification-2026-09-14/fix-v3';
...
export function buildLocal(){
 ...
 const indices=sets.map((s,i)=>ids.includes(s.id)?i:-1).filter(i=>i>=0);assert.equal(indices.length,2);
