// 경계 사례 B1·B2 수정 2세트의 운영 DB 반영. case-trio 추가 게시 driver를 교체 계약으로 옮겼다.
...
//   node --env-file=.env.local --import tsx cpa_uploader/analysis/reviews/standard-new-verification-2026-09-14/fix-v3/db-incremental-v1/driver.mjs <mode> [--expected-preparation-sha256 SHA]
