// 운영 active release에 저장된 원문을 그대로 두고, 수정된 10세트 객체의 텍스트만 같은 위치에 바꿔 끼워 최종 원문을 복원한다.
...
export const F='cpa_uploader/analysis/reviews/standard-new-verification-2026-09-14/fix-v1';
