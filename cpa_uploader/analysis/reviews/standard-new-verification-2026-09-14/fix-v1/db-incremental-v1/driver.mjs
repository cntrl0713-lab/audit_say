// 수정 10세트의 운영 DB 반영. case-trio 추가 게시 driver를 교체 계약으로 옮겼다.
...
//   node --env-file=.env.local --import tsx cpa_uploader/analysis/reviews/standard-new-verification-2026-09-14/fix-v1/db-incremental-v1/driver.mjs <mode> [--expected-preparation-sha256 SHA]
...
// preparation-v1은 읽기 전용 API에서 SET ROLE이 거부된 probe 실패 기록(probe-failure.json)과 함께 보존한다.
const P=N+'/preparation-v2',O=F+'/db-publication-v1';
