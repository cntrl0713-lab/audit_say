...
const D='cpa_uploader/analysis/reviews/case-trio-2026-09-14';
...
const baseline=read(D+'/integration-baseline/bank.json');
...
if(mode==='--stage'){
 ...
 const immutable=[D+'/candidate-v1.json',D+'/classification-v1.json',D+'/changed-sets-v1.json',D+'/integration-baseline.json',D+'/integration-baseline/bank.json',D+'/sealed-v1/batch.json',D+'/sealed-v1/readiness.json'].map(ref);
