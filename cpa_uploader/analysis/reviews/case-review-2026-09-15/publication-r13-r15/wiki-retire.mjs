// 퇴역한 원 8세트의 wiki 생성 페이지를 원 바이트로 보존한 뒤 제거한다(정본 설치 뒤 한 번 실행; 이어서 wiki:build).
//   node cpa_uploader/analysis/reviews/case-review-2026-09-15/publication-r13-r15/wiki-retire.mjs
import fs from 'node:fs';
import assert from 'node:assert/strict';
import { createHash } from 'node:crypto';

const P = 'cpa_uploader/analysis/reviews/case-review-2026-09-15/publication-r13-r15', W = P + '/wiki-retirement';
