...
const record={reviewer_id:'Codex root — 최종 원문·사실·발문·정답·배점·대표 기대값 직접 대조',reviewed_at:new Date().toISOString(),method:'agent_content_review',human_review_performed:false,
 evidence:['a/sets.json','a/design.json','a/review.json','a/qa.json','b/sets.json','b/design.json','b/review.json','b/qa.json','a-peer-review.json','b-peer-review.json','source-peer-review.json'].map(f=>ref(D+'/'+f)),
