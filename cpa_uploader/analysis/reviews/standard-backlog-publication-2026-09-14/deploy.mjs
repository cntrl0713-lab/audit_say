...
//   node --env-file=.env.local --import tsx cpa_uploader/analysis/reviews/standard-backlog-publication-2026-09-14/deploy.mjs
...
const base='cpa_uploader/analysis/reviews/standard-backlog-publication-2026-09-14',out=base+'/db-publication-v1';
