...
//   node cpa_uploader/analysis/reviews/standard-backlog-publication-2026-09-14/update-coverage.mjs
...
const rows=ledger.links.filter(l=>l.target?.scope==='draft'&&/cpa_uploader\/drafts\/standard-(gap|expansion|followup)-2026-09-13\//.test(l.target.file));assert.equal(rows.length,16);
