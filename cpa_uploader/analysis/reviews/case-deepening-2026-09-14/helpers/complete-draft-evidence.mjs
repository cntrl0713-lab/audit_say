...
const sources=['a','b'].flatMap(authorSources),sourcePlan=sourceEvidencePlan();
const files=[...new Set([...original.map(e=>e.file),...extra,...sources.map(e=>e.file),...sourcePlan.files.map(e=>e.file),
 D+'/source-catalog-final.json',D+'/a-peer-review.json',D+'/b-peer-review.json',
 R+'/helpers/source-evidence.mjs',R+'/helpers/complete-draft-evidence.mjs',R+'/helpers/provenance.json',R+'/helpers/provenance-v2.json'])];
