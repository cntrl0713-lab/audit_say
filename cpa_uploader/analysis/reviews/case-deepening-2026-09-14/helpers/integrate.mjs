...
for(const agent of ['a','b']){
 ...
 assert.equal(sets.length,3);assert.equal(rs.length,9);validateQaBank(sets,cases);
...
const qaScope=validateQaBank(changes,qa);assert.equal(qaScope.question_count,18);
