...
const collection='cpa_uploader/raw/collections/2026-09-14-case-deepening';
...
for(const f of [
 ...['230','260','330','501'].map(n=>'cpa_uploader/data/official/case-deepening-2026-09-14-kga'+n+'.md'),
