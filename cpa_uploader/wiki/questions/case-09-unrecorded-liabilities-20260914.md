...
- 정본: [authoring JSON](../../data/cpa_question_sets_v3.authoring.json) · JSON Pointer `/175`
...
유형: descriptive · JSON Pointer `/175/subquestions/0`
...
유형: descriptive · JSON Pointer `/175/subquestions/1`
...
유형: descriptive · JSON Pointer `/175/subquestions/2`
