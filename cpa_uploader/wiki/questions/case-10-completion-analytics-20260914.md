...
- 정본: [authoring JSON](../../data/cpa_question_sets_v3.authoring.json) · JSON Pointer `/347`
...
유형: judgment · JSON Pointer `/347/subquestions/0`
...
유형: descriptive · JSON Pointer `/347/subquestions/1`
...
유형: judgment · JSON Pointer `/347/subquestions/2`
