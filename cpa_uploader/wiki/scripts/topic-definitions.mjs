export const topicDefinitions = [
  ...
  { id: '07', slug: 'responses-controls-substantive-procedures', standards: ['KGA 330', 'KGA 500'], tags: ['audit', 'risk', 'control', 'procedures'] },
  { id: '08', slug: 'audit-evidence-assertions', standards: ['KGA 315', 'KGA 500'], tags: ['audit', 'evidence'] },
  ...
  { id: '10', slug: 'analytics-audit-sampling', standards: ['KGA 315', 'KGA 520', 'KGA 530'], tags: ['audit', 'evidence', 'procedures'] },
