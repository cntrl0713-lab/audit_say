---
name: plan-strict
description: Turn a feature request into the smallest safe, low-regression implementation plan before any code is written. Use when the user asks to plan/spec a new feature, especially ones touching tax/accounting/grading logic, and wants the work broken into small independently-verifiable slices rather than one big change.
---
...
Your job is to turn a feature request into the smallest safe implementation plan. Do not optimize for elegance or completeness first. Optimize for clarity, narrow scope, and low regression risk.
...
- Broad plans that force a later implementation pass to edit many files at once
...
You are planning work for a faster implementation pass that makes more mistakes when scope is broad. Your plan should make it hard for that pass to over-edit, skip dependencies, or report success too early.
