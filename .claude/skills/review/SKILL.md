---
name: review
description: Review code, a diff, or a design and return actionable, prioritized feedback. Verifies claimed changes against the actual current code, traces data flow for renamed/changed fields, checks for regressions against earlier fixes, flags tax/accounting domain issues and missing tests, and gives concrete file:line fixes. Use when asked to review a change rather than implement one.
---
